        ...
        <>
            ...
            >
                ...
                <div className="container mx-auto px-6 text-center relative z-10 max-w-5xl">
                    ...
                    >
                        We are a subscription-based web design agency, delivering high-quality,
                        <br className="hidden md:block" />
                        scalable websites designed to <span className="text-white font-medium">drive results and grow your business.</span>
                    </p>
                </div>
